...
$DEVELOPER_ID = "1007779784546061277";

//自分のアフィリエイトID

$AFFILIATE_ID = "158950e1.4c4e0c18.158950e2.b9b279cc";
...
$API_BASE_URL   = "https://app.rakuten.co.jp/services/api/Recipe/CategoryList/20121121?format=json&categoryType=small&applicationId=1050242865633673536";
...
<?php if($status!= ""){?>取得結果: <?=$status?><br><?php } ?>
<?php if($statusmsg!= ""){ ?>取得内容: <?=$statusmsg?><br><?php } ?>
